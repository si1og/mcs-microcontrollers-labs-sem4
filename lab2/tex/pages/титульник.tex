...
\begin{center}
    ...
    \large Отчёт о выполнении лабораторной работы №2 \\[5pt]
    \large По дисциплине: <<Программирование микроконтроллеров>>\\[10pt]
    \large На тему: <<Использование библиотек в Keil µVision5>>\\[5pt]
\end{center}
